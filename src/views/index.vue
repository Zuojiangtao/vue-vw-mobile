...
* @date 2020/1/17
* @company MyselfStudy
* @description Vue移动端APP自适应登录页面
* Copyright (c) 2020, 左江涛 GROUP.
* All rights reserved.
*/
<template>
  <div class='app'>
      ...
      <div class="signin">
        <div class="form">
          <div class="ipt" id="name">
            ...
            <button v-show="name" id="deleteName" @click.stop="clearName"><img src="@/assets/delete.png" alt=""></button>
          </div>
    ...
    <div class="footer">
      ...
      <ul>
        <li>
          <img src="@/assets/check.png" alt=""><span>访问您账号的公开信息（用户名、头像等）</span>
        </li>
        <li>
          <img src="@/assets/check.png" alt=""><span>获取您的账号关联的FIKS设备信息</span>
        </li>
      </ul>
    </div>
  </div>
